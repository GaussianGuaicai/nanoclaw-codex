...
import { createAgentRuntime, getAgentProvider } from './runtime/index.js';
...
async function main(): Promise<void> {
  ...
  const runtime = createAgentRuntime(
    provider,
    {
      ...
      onPreCompact: createPreCompactHook(containerInput.assistantName),
      onPreToolUseBash: createSanitizeBashHook(),
    },
    shouldClose,
    drainIpcInput,
    IPC_POLL_MS,
